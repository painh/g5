...
//		if(!CheckTouchable())
		...
		ui_y += 60;
		g_btnShopIncrFever = g_merchant.Add(0, ui_y, 150, ui_width, '피버게이지 증가', this, 'pressIncrFever');
		ui_y += 60;
...
//		Renderer.Text(0, Renderer.height - 20, 'combom : ' + this.combo);
		...
		Renderer.Text(0, 0, 'hp : ' + g_player.hp + ' gold : ' + g_gold );
	...
	{ 
		...
		targetBtn.caption			= '공격력 증가 / '+g_price_ap+' gold';
		...
		var targetBtn = g_btnShopIncrFever;
		if(g_gold >= g_price_fever) targetBtn.captionColor = '#fff';
		else targetBtn.captionColor = '#f00';
		targetBtn.caption			= '피버증가 10 / '+g_price_fever+' gold';
